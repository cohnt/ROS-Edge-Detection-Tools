...
ax1 = fig.add_subplot(221) # Top left -- camera feed
ax2 = fig.add_subplot(222) # Top right -- camera edges
ax3 = fig.add_subplot(223) # Bottom left -- depth feed
ax4 = fig.add_subplot(224) # Bottom right -- depth edges
